...
<head>
  ...
  <title>SMKN 11 Bandung | Data Guru</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-star-o"></i> Kalender Akademik</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li><a href="<?php echo base_url().'admin/kompetensi/add_kompetensi'?>"><i class="fa fa-thumb-tack"></i>  Posta Kompetensi</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="#">Tim ICT SMKN 11 Bandung</a>.</strong> All rights reserved.
  </footer>
