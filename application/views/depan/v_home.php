...
<head>
    ...
    <title>SMKN11BDG - Selamat Datang di SMKN 11 Bandung</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>COMMITED to the PROGRESS by</h1>
                            <h4>TEACHING, LOVING and CARING each other.<br> Itulah yang kami lakukan.</h4>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Sarana Pra sarana Penunjang</h1>
                            <h4>Sarana dan Pra sarana merupakan faktor penting dalam kegiatan belajar-mengajar.<br> Itulah kenapa kami menyediakan yang <br>terbaik dari ahlinya.</h4>
                            <div class="slider-btn">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               ...
               <p>Kami Menyambut baik terbitnya Website SMK Negeri 11 Bandung yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright 2020. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
